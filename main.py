...
prop_X = BlottoProp(connectivity=Connectivity, x0=x_0, T=T, agent_name="Defender")
...
ax_Y = prop_Y.vertex_flow[-1].plot(ax_Y, color='m')

ax_X = prop_X.plot_simplex(t=0)
ax_X = prop_X.vertex_flow[-1].plot(ax_X, color='m')
