...
vertices_1 = remove_non_vertex_auxPoint(points_1, need_connections=True)
vertices_2 = remove_non_vertex_auxPoint(points_2, need_connections=True)
vertices, rays, found = intersect(vertices_1, vertices_2)

vertices_new = remove_non_vertex_auxPoint(vertices.vertices, need_connections=True)
