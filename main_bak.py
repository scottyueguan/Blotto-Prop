...
prop_X = BlottoProp(connectivity=Connectivity, T=T, agent_name="Defender", hull_method='aux_point',
                    need_connections=True)
prop_X.set_initial_vertices([x_0], perturb_singleton=True)
prop_Y = BlottoProp(connectivity=Connectivity, T=T, agent_name="Attacker", hull_method='aux_point',
                    need_connections=True)
prop_Y.set_initial_vertices([y_0], perturb_singleton=True)
